...
| [react-native-nitro-modules](https://www.npmjs.com/package/react-native-nitro-modules) | `>=0.35.7` (peer dependency) |
| [ratex-react-native](https://www.npmjs.com/package/ratex-react-native) | `>=0.1.4` (peer dependency, math rendering) |
| iOS | 16.4+ |
