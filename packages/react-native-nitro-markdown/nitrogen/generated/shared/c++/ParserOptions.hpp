...
namespace margelo::nitro::Markdown {
  ...
  public:
    ...
    std::optional<bool> freezeAst     SWIFT_PRIVATE;

  public:
    ParserOptions() = default;
    explicit ParserOptions(std::optional<bool> gfm, std::optional<bool> math, std::optional<bool> html, std::optional<bool> sourceOffsets, std::optional<double> maxInputLength, std::optional<bool> freezeAst): gfm(gfm), math(math), html(html), sourceOffsets(sourceOffsets), maxInputLength(maxInputLength), freezeAst(freezeAst) {}
  ...
  struct JSIConverter<margelo::nitro::Markdown::ParserOptions> final {
    static inline margelo::nitro::Markdown::ParserOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::Markdown::ParserOptions(
        ...
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "freezeAst")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::Markdown::ParserOptions& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "freezeAst"), JSIConverter<std::optional<bool>>::toJSI(runtime, arg.freezeAst));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<bool>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "freezeAst")))) return false;
      return true;
    }
  };
